...
En 1660, Louis XIV et sa jeune femme, l'infante Marie-Thérèse, y firent leur entrée dans Paris. Un trône y fut élevé à cette occasion, d'où le nom qui fut donné à la place, et le roi y reçut les hommages de la Ville. ", url_image: "https://tse4.mm.bing.net/th?id=OIP.CWPTxC74DifA-YihlnpAPQHaFY&pid=Api&P=0", poi_id: 3)
...
Quand aux conspirateurs, ils seront guillotinés le 19 février 1836. Fieschi, pour sa part, la tête sur l'échafaud, demanda pardon à Dieu et aux hommes. Mieux vaut tard que jamais...", url_image: "https://tse2.mm.bing.net/th?id=OIP.ylKctxuCk8wlYGH6p92j1AHaI_&pid=Api&P=0")
...
C'est aussi au n°130 du boulevard Richard-Lenoir que l'écrivain Simenon a domicilié le célèbre commissaire Maigret.", url_image: "https://tse2.mm.bing.net/th?id=OIP.VgtFy5uvSteVGmIZQnpQ-AHaIT&pid=Api&P=0")
...
Il s'appelait Maurice Chevalier, et fut appelé à un brillant avenir. Avez-vous vu le nouveau chapeau de Toto ? Prosper Youp la boum, c'est le chéri de ces dames...Ah, les gars d'Ménilmontant...", url_image: "https://tse2.explicit.bing.net/th?id=OIP.1-kS9w0_IeXJhNXXs53jNQHaHa&pid=Api&P=0")
...
TripPlace.create(trip_id: 1, place_id: 35)
TripPlace.create(trip_id: 1, place_id: 4)
TripPlace.create(trip_id: 1, place_id: 12)
TripPlace.create(trip_id: 1, place_id: 16)
TripPlace.create(trip_id: 1, place_id: 19)
TripPlace.create(trip_id: 1, place_id: 22)
...
TripPlace.create(trip_id: 2, place_id: 17)
TripPlace.create(trip_id: 2, place_id: 18)
TripPlace.create(trip_id: 2, place_id: 20)
TripPlace.create(trip_id: 2, place_id: 21)
TripPlace.create(trip_id: 2, place_id: 23)
TripPlace.create(trip_id: 2, place_id: 24)
TripPlace.create(trip_id: 2, place_id: 29)
# Les soirées Parisiennes
TripPlace.create(trip_id: 3, place_id: 9)
TripPlace.create(trip_id: 3, place_id: 25)
TripPlace.create(trip_id: 3, place_id: 26)
TripPlace.create(trip_id: 3, place_id: 27)
TripPlace.create(trip_id: 3, place_id: 30)
TripPlace.create(trip_id: 3, place_id: 31)
TripPlace.create(trip_id: 3, place_id: 32)
# Curiosités
TripPlace.create(trip_id: 4, place_id: 13)
TripPlace.create(trip_id: 4, place_id: 28)
TripPlace.create(trip_id: 4, place_id: 14)
TripPlace.create(trip_id: 4, place_id: 15)
TripPlace.create(trip_id: 4, place_id: 36)
...
PlaceCategory.create(place_id: 35, category_id: 1)
PlaceCategory.create(place_id: 4, category_id: 2)
PlaceCategory.create(place_id: 12, category_id: 2)
PlaceCategory.create(place_id: 16, category_id: 2)
PlaceCategory.create(place_id: 19, category_id: 2)
PlaceCategory.create(place_id: 22, category_id: 2)
PlaceCategory.create(place_id: 33, category_id: 2)
PlaceCategory.create(place_id: 34, category_id: 2)
PlaceCategory.create(place_id: 8, category_id: 3)
PlaceCategory.create(place_id: 17, category_id: 3)
PlaceCategory.create(place_id: 18, category_id: 3)
PlaceCategory.create(place_id: 20, category_id: 3)
PlaceCategory.create(place_id: 21, category_id: 3)
PlaceCategory.create(place_id: 23, category_id: 3)
PlaceCategory.create(place_id: 24, category_id: 3)
PlaceCategory.create(place_id: 29, category_id: 3)
...
PlaceCategory.create(place_id: 27, category_id: 4)
PlaceCategory.create(place_id: 30, category_id: 4)
PlaceCategory.create(place_id: 31, category_id: 4)
PlaceCategory.create(place_id: 32, category_id: 4)
PlaceCategory.create(place_id: 13, category_id: 5)
PlaceCategory.create(place_id: 28, category_id: 5)
...
Comment.create(content: "Sous la colonne, érigée au centre de la Place de la Bastille à la mémoire des insurgés des 3 Glorieuses, reposent les restes de 500 combattants de ces événements. Mais pas seulement ! Y reposent aussi des momies rapportées par Bonaparte de son expédition d'Egypte, et qui furent entreposées à cet endroit par erreur.", rating: 0, user_id: 2, place_id: 16)
